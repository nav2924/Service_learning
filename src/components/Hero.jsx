      ...
      <section className="bg-[#FCF8F1] bg-opacity-30 py-10 sm:py-16 lg:py-24">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 mt-10 lg:px-8">
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
              ...
              <BoxReveal boxColor={"#5046e6"} duration={0.5}>
                <a
                  href="#"
                  title=""
                  className="inline-flex items-center px-6 py-4 mt-8 text-xl font-semibold text-black transition-all duration-200 bg-lime-600 rounded-full lg:mt-16 hover:bg-yellow-400 focus:bg-yellow-400"
                  role="button"
                >
                  Donate Us
                  <svg
            ...
            <div>
              <img className="w-full rounded-lg" src="/hero.jpg" alt="" />
            </div>
          </div>
        </div>
      </section>
