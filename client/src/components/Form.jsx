...
const Form = () => {
  return (
    <div>
      <section class="min-h-screen bg-gradient-to-r from-lime-900 via-lime-200 to-lime-100 dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 ">
        <div class="container flex flex-col min-h-screen px-6 py-12 mx-auto">
          <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
            ...
            <div class="mt-24 lg:w-1/2 lg:mx-6">
              <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                ...
                <form class="mt-4">
                  <div class="flex-1">
                    <label class="block mb-2 text-sm font-semibold text-gray-600 dark:text-gray-200">
                      Full Name
                    </label>
                    <input
                      type="text"
                  ...
                  <button class="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-emerald-600 rounded-md hover:bg-emerald-500 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                    get in touch
                  </button>
                </form>
              </div>
